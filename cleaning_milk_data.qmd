...
```{r}
# removing NA values  and putting them in the treatment
...
milk_df1 <- milk_data|>
  select(consumer_likelihood, average_purchase, DairyPro_1, DairyCon_1, DairyPic_1, PlantPro_1, PlantCon_1, PlantPic_1, DairyPro_2, DairyCon_2, DairyPic_2, PlantPro_2, PlantCon_2, PlantPic_2, treatment)
```
